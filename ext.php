...
namespace david63\resetregdate;
...
class ext extends base
{
	...
	*/
	public function is_enableable()
	{
		...
		$is_enableable = phpbb_version_compare(PHPBB_VERSION, '3.2.2', '>=');
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/resetregdate');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/resetregdate', 'ext_enable_error');
			}
		}
